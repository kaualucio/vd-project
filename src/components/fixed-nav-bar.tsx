    ...
    <div className="fixed bottom-5 w-full">
      ...
      >
        <div className="flex items-end gap-3">
          ...
          <button onClick={handleStart} className="cursor-pointer text-white text-sm font-thin bg-transparent hover:bg-zinc-700 duration-200 flex items-center gap-5 sm:gap-2 rounded-full px-3 sm:px-2 py-3">
